...
import { deleteTask, doneTask } from "../redux/taskSlice";

export const UndoneTaskList = () => {

  const {tasksUndone} = useSelector(state => state.tasks);
  ...
  return (
    <div className="flex flex-col gap-2 bg-gray-900 rounded-md p-5 " >
      ...
      {
        tasksUndone.length === 0 || tasksUndone[0] === ""
